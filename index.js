...
function changeRole(array, newRole) {
  ...
  for (const val of array) { 
      val.role = newRole;  // Змінюємо роль кожного користувача на нове ім'я
  }
...
function printProductDetails(obj) {
  ...
  let {productName, price, manufacturer:{companyName}, manufacturer:{country}} = obj;
...
function showCarInfo({
  ...
  // Повертаємо об'єкт зі значеннями властивостей
   return `{brand: ${brand}, yaer: ${year}, country: ${country}}`;
}
...
let  newArr = addProperty([...firstArrayArray]);
